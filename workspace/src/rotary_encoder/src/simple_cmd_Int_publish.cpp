...
std_msgs::Int8MultiArray cmdmotorspeed;

void cmd_vel_callback(const geometry_msgs::Twist& msg) {
  cmdmotorspeed.data[0]  = (int8_t)((msg.linear.x - msg.angular.z * base_width / 2.0) / wheel_radius) * 10;    
  cmdmotorspeed.data[1]  = (int8_t)((msg.linear.x + msg.angular.z * base_width / 2.0) / wheel_radius) * 10;   
}
...
int main(int argc, char** argv) {
  ...
  ros::Publisher cmdmotorspeed_pub = nh.advertise<std_msgs::Int8MultiArray>("cmdmotorspeed", 10);
